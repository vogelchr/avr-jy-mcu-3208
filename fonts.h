...
extern uint8_t font_puts_RAM(
	enum font fontnum, const char *s, uint8_t *fb, int x,
	int xspace, int y, enum font_stamp_mode mode );

extern uint8_t font_puts_P(
	enum font fontnum, const char *s, uint8_t *fb, int x,
	int xspace, int y, enum font_stamp_mode mode );

extern uint8_t fonts_put_char(
	enum font fontnum, char c, uint8_t *fb, int x,
	int xspace, int y, enum font_stamp_mode mode );
